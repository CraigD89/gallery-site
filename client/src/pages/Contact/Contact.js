        ...
        <Grid item xs={12} md={6}>
          <div className="contact">
            ...
            <div className="contactCenter">
              <h4>
                Efrain Lopez Gallery is a contemporary art gallery in Chicago,
                IL. The gallery is committed to showcasing work by emerging and
                established visual artists that is visually engaging and
                conceptually captivating. A wide range of media is represented
                in the gallery's curatorial program.
              </h4>
            </div>
          </div>
          <div className="contact">
